...
# 🚫 ഒഴിവാക്കേണ്ട ചാനൽ / ഗ്രൂപ്പ് ടാഗുകൾ ഇവിടെ ആഡ് ചെയ്യാം
# ചിഹ്നങ്ങൾ ഇല്ലാതെ വെറും വാക്കുകൾ മാത്രം നൽകുക (eg: 'ms' എന്ന് കൊടുത്താൽ [MS], [ms], -MS- ഒക്കെ മാറും)
CUSTOM_TAGS = [
    "ms", 
    "team-ms", 
    "urvashi", 
    "team_urvashi", 
    "adhityan",
    "movie_channel" # ഉദാഹരണത്തിന് പുതിയത് ആഡ് ചെയ്യാം
]
